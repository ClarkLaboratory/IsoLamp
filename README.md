...
|reverse_primers|optional|NULL|BED file of reverse primers. Only checked if primer_site_based_filter is TRUE. Note: the number of lines in this file must correspond to the number of forward primers (check with wc -l file.bed)|
